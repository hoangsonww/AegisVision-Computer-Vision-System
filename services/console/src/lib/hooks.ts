...
export const qk = {
  ...
  pipelineRevisions: (id: string) => ['pipeline-revisions', id],
  streams: () => ['streams'],
  stream: (id: string) => ['stream', id],
  models: () => ['models'],
  model: (id: string) => ['model', id],
  modelVersions: (id: string) => ['model-versions', id],
  datasets: () => ['datasets'],
  dataset: (id: string) => ['dataset', id],
  datasetVersions: (id: string) => ['dataset-versions', id],
  samples: (id: string, v: string) => ['samples', id, v],
  ...
  agentSteps: (id: string) => ['agent-steps', id],
  gates: () => ['gates'],
  gate: (id: string) => ['gate', id],
  canary: () => ['canary'],
  canaryPlan: (id: string) => ['canary', id],
  canaryState: (id: string) => ['canary-state', id],
  drift: () => ['drift'],
  driftRun: (id: string) => ['drift', id],
  slo: () => ['slo'],
  prefetch: () => ['prefetch'],
  knowledge: () => ['knowledge'],
  al: () => ['al'],
  search: (q: string) => ['search', q],
  usage: (p: Record<string, unknown>) => ['usage', p],
  invoices: () => ['invoices'],
  controls: () => ['controls'],
  audit: (p: Record<string, unknown>) => ['audit', p],
  rules: () => ['rules'],
};
