module github.com/aegisvision/services/knowledge-service

go 1.26.0

require (
	github.com/aegisvision/pkg/embeddings v0.0.0
...
replace (
	github.com/aegisvision/pkg/embeddings => ../../pkg/embeddings
