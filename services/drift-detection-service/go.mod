module github.com/aegisvision/services/drift-detection-service

go 1.26.0

require (
	github.com/aegisvision/pkg/autonomy v0.0.0
...
replace (
	github.com/aegisvision/pkg/autonomy => ../../pkg/autonomy
