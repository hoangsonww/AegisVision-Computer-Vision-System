...
A contributor becomes a **trusted contributor** after a consistent
...
"AegisVision" as a project name + logo are owned by Son Nguyen. Use
of the name to identify your *own* product or service requires
permission. Use of the name to identify *use* of the software ("our
platform uses AegisVision") does not.

---

## Funding + sponsorship

See [`.github/FUNDING.yml`](./.github/FUNDING.yml). The project is not
currently sponsored by any commercial entity.
